...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "الخدامة هي اللي تطبخ غالباً في البيت. عشان توصل وجبات صحية لعائلتك زي ما خططتي لها، الخدامة لازم تفهم الوصفة بلغتها. النظام يعطيها الوصفات والمقادير الدقيقة بلغتها — تجالوج، بنغالي، هندي، إندونيسي، أمهري، أردو، أو عربي مبسط — عشان كل وجبة تطلع تمام.",
  },
  {
