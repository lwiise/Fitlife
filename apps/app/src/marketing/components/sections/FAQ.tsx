...
const faqs: FAQItem[] = [
  {
    question: "كم سؤال محتاج أجاوب عشان أبدأ؟",
    answer:
      "٨ أسئلة شخصية عنك + ٥ أسئلة عن عائلتك. تستغرق ٥-٦ دقايق. كل فرد جديد تضيفينه يأخذ ٨ أسئلة إضافية فقط.",
  },
  {
    question: "ليش الخدامة جزء من النظام؟",
    answer:
      "الخدامة في كثير من البيوت هي اللي تطبخ. عشان توصل وجبات صحية لعائلتك زي ما خططتيها بالظبط، الخدامة لازم تفهم الوصفة والمقادير. النظام يعطيها تعليمات الطبخ بلغتها — تجالوج، بنغالي، هندي، إندونيسي، أمهري، أردو، أو عربي مبسط — عشان كل وجبة تطلع زي ما تبين.",
  },
  {
    question: "هل الخطط مناسبة للحامل أو المرضعة؟",
    answer:
      "نعم، باقة البريميوم تتضمن خطط خاصة للحوامل والمرضعات، يراجعها فريق التغذية بقيادة ساره الشيخ. للحالات الخاصة مثل سكري الحمل أو ضغط الدم، الخطة تتعدل تلقائياً حسب فحوصاتك.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "بضغطة من إعدادات حسابك. بدون اتصالات، بدون أسئلة، بدون استبيانات. تستمر خطتك حتى نهاية الفترة المدفوعة، وبعدها يتوقف التجديد.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "نعم. أول 7 أيام مجانية، بدون الحاجة لبطاقة ائتمان. بعد التجربة تختارين الباقة المناسبة، وتقدرين تلغين في أي وقت بضغطة.",
  },
];
