...
export const EXERCISE_CATALOG: CatalogExercise[] = [
  ...
  { id: "barbell_back_squat", name_ar: "سكوات بالبار", name_en: "Barbell Back Squat", target_muscles_ar: "الفخذان والمؤخرة", pattern: "squat", equipment: ["barbell"], home_ok: false, pregnancy_safe: false },
  { id: "barbell_deadlift", name_ar: "الرفعة الأرضية بالبار", name_en: "Barbell Deadlift", target_muscles_ar: "الظهر وأوتار الفخذ والمؤخرة", pattern: "hinge", equipment: ["barbell"], home_ok: false, pregnancy_safe: false },
  { id: "barbell_hip_thrust", name_ar: "دفع الورك بالبار على المقعد", name_en: "Barbell Hip Thrust", target_muscles_ar: "المؤخرة", pattern: "hinge", equipment: ["barbell", "bench"], home_ok: false, pregnancy_safe: false },
  { id: "hip_abduction", name_ar: "فتح الوركين بالجهاز", name_en: "Hip Abduction Machine", target_muscles_ar: "جانب المؤخرة", pattern: "isolation", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  { id: "cable_glute_kickback", name_ar: "ركلة المؤخرة بالكابل", name_en: "Cable Glute Kickback", target_muscles_ar: "المؤخرة", pattern: "isolation", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  { id: "seated_calf_raise", name_ar: "رفعات السمانة جالسة بالجهاز", name_en: "Seated Calf Raise", target_muscles_ar: "السمانة", pattern: "isolation", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  ...
  { id: "chest_press_machine", name_ar: "ضغط الصدر بالجهاز جالسة", name_en: "Chest Press Machine", target_muscles_ar: "الصدر والترايسبس", pattern: "push", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  { id: "shoulder_press_machine", name_ar: "ضغط الكتف بالجهاز جالسة", name_en: "Shoulder Press Machine", target_muscles_ar: "الكتفان والترايسبس", pattern: "push", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  ...
  { id: "towel_row", name_ar: "التجديف بالمنشفة على الباب", name_en: "Towel Door Row", target_muscles_ar: "الظهر والبايسبس", pattern: "pull", equipment: [], home_ok: true, pregnancy_safe: true },
  { id: "reverse_pec_deck", name_ar: "الرفرفة الخلفية بالجهاز", name_en: "Reverse Pec Deck", target_muscles_ar: "الكتف الخلفي وأعلى الظهر", pattern: "isolation", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  { id: "cable_biceps_curl", name_ar: "ثني البايسبس بالكابل", name_en: "Cable Biceps Curl", target_muscles_ar: "البايسبس", pattern: "isolation", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
  ...
  { id: "superman", name_ar: "سوبرمان — رفع الصدر والساقين انبطاحاً", name_en: "Superman Hold", target_muscles_ar: "أسفل الظهر والمؤخرة", pattern: "core", equipment: [], home_ok: true, pregnancy_safe: false },
  ...
  { id: "rowing_machine", name_ar: "جهاز التجديف", name_en: "Rowing Machine", target_muscles_ar: "القلب والجسم كاملاً", pattern: "cardio", equipment: ["machine"], home_ok: false, pregnancy_safe: false },
  { id: "elliptical", name_ar: "جهاز الإلبتيكال", name_en: "Elliptical", target_muscles_ar: "القلب والأوعية", pattern: "cardio", equipment: ["machine"], home_ok: false, pregnancy_safe: true },
...
اختاري لكل تمرين exercise_id من هذه القائمة فقط — الاسم والوصف يبقيان بصياغتك، لكن المعرّف يجب أن يطابق القائمة حرفياً. اختاري ما يناسب مكان التدريب وأدوات المتدرب وحالته الصحية.
${lines.join("\n")}`;
}
